...
export default function AccountNavigation(){
    ...
    const linkClasses = (page) => {
        ...
        return page === subpage ? 'inline-flex gap-1 bg-primary dark:text-primary-50 rounded-full px-6 py-2' : 'inline-flex gap-1 rounded-full border-2 px-6 py-2 dark:text-primary-50 ';

    };

    return(

        <nav className="flex justify-center gap-5 mb-8 mt-12">
